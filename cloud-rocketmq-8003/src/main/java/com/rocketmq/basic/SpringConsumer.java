 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "MyConsumerGroup",topic = "LW_NEW_SYSTEM_TEST",consumeMode = ConsumeMode.CONCURRENTLY,messageModel = MessageModel.BROADCASTING)
